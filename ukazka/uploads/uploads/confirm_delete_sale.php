...
if ($confirm) {
    ...
    try {
        // Subtract amount_paid from customer's total_paid
        ...
        logHistory($conn, "delete_sale", "Deleted sale ID $sale_id: $buyer_name, subtracted $amount_paid Kč from total_paid");
